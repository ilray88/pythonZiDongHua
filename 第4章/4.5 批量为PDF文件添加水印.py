...
def create_watermark(content):
    ...
    reportlab.pdfbase.pdfmetrics.registerFont(reportlab.pdfbase.ttfonts.TTFont('阿里巴巴普惠体', 'F:\\代码文件\\第4章\\Alibaba-PuHuiTi-Regular.ttf'))
...
des_folder = Path('F:\\代码文件\\第4章\\公告添加水印后\\')
